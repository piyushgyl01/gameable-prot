export const PILLARS = {
  vitality: { name: 'Vitality', color: '#10b981' },
  mastery: { name: 'Mastery', color: '#818cf8' },
  bonds: { name: 'Bonds', color: '#f59e0b' },
};

export const MAIN_QUESTS = [
  {
    id: 'iron', p: 'vitality', ic: '🏋️', nm: 'Iron Path', pk: 3,
    subs: [
  ...
  {
    id: 'bulk', p: 'vitality', ic: '🍗', nm: 'Bulk Protocol', pk: 2,
    subs: [
  ...
  {
    id: 'dsa', p: 'mastery', ic: '🧩', nm: 'Algorithm Forge', pk: 2,
    subs: [
  ...
  {
    id: 'stack', p: 'mastery', ic: '🌐', nm: 'Full Stack', pk: 2,
    subs: [
  ...
  {
    id: 'ai', p: 'mastery', ic: '🤖', nm: 'AI Frontier', pk: 2,
    subs: [
  ...
  {
    id: 'bca', p: 'mastery', ic: '🎓', nm: 'BCA Hold', pk: 3,
    subs: [
  ...
  {
    id: 'gre', p: 'mastery', ic: '🎯', nm: 'SF Blueprint', pk: 2,
    subs: [
  ...
  {
    id: 'money', p: 'mastery', ic: '💰', nm: 'Income Hunt', pk: 2,
    subs: [
  ...
  {
    id: 'roots', p: 'bonds', ic: '🏠', nm: 'The Roots', pk: 2,
    subs: [
  ...
  {
    id: 'city', p: 'bonds', ic: '🏙️', nm: 'BLR Network', pk: 2,
    subs: [
  ...
  {
    id: 'self', p: 'bonds', ic: '🪞', nm: 'Inner Work', pk: 2,
    subs: [
