...
export default function ProgressRing({ percentage }) {
  ...
  return (
    <svg width="86" height="86" viewBox="0 0 90 90">
      ...
      />
      <text x="45" y="43" textAnchor="middle" fill={col} fontFamily="'JetBrains Mono', monospace" fontWeight="700" fontSize="18">
        {Math.round(pct)}%
      </text>
      <text x="45" y="56" textAnchor="middle" fill="var(--text-dim)" fontWeight="600" fontSize="8" letterSpacing="1">
        TODAY
      </text>
    </svg>
  );
